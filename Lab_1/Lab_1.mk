...
ProjectPath            :=C:/Users/cheun/Documents/ECEGR2020/Lab_1
...
../build-$(ConfigurationName)/Lab_1/main.c$(ObjectSuffix): main.c ../build-$(ConfigurationName)/Lab_1/main.c$(DependSuffix)
	$(CC) $(SourceSwitch) "C:/Users/cheun/Documents/ECEGR2020/Lab_1/main.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/main.c$(ObjectSuffix) $(IncludePath)
