...
ProjectPath            :=C:/Users/cheun/Documents/ECEGR2020/Lab2
...
../build-$(ConfigurationName)/Lab2/main.c$(ObjectSuffix): main.c ../build-$(ConfigurationName)/Lab2/main.c$(DependSuffix)
	$(CC) $(SourceSwitch) "C:/Users/cheun/Documents/ECEGR2020/Lab2/main.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/main.c$(ObjectSuffix) $(IncludePath)
